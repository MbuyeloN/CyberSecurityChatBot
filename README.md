...
- **Assessment:** Part 1  
- **Student Name:** Mbuyelo P. Nkuna 
- **Student Number:** ST10473424
...
The chatbot greets the user with both **ASCII art and voice output**, asks for their name, and provides **personalised responses** to various cybersecurity-related questions.
...
It also supports general conversation such as:
- "How are you?"
- "What can you do?"
- "Thank you"
...
- Separation of responsibilities (UI, logic, speech)
...
- **IDE:** Visual Studio  
- **Library:** System.Speech (Text-to-Speech)
...
- Add GUI interface instead of console
- Improve voice interaction with different voices
...
It combines technical implementation with practical real-world application, making it both functional and informative.
...
- Additional learning resources on cybersecurity concepts
